...
/****** Object:  View [qc].[CAM.PK]    Script Date: 22/09/2025 ******/
SET ANSI_NULLS ON
GO
...
-- QC rule code: CAM.PK
-- QC rule name: CAM.PK Constraint - [CountryCode,AssessmentRegimeId,DataAggregationProcessId,AssessmentMethodId,AttainmentId]
