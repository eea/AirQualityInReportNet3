...
/****** Object:  View [qc].[MORI_PK]    Script Date: 22/09/2025 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [qc].[MORI_PK] AS

-- Creation date: 22 September 2025
-- QC rule code: MORI_PK
-- QC rule name: MORI_PK Constraint - [CountryCode,AssessmentMethodId,Start,DataAggregationProcessId,X,Y]
