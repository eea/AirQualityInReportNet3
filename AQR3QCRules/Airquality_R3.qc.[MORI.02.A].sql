...
/****** Object:  View [qc].[MORI.02.A]    Script Date: 26/08/2025 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [qc].[MORI.02.A] AS

-- Creation date: 26 August 2025
-- QC rule code: MORI.02.A
-- QC rule name: MORI.02.A Cross-check - [AssessmentMethodId] MOD.02
