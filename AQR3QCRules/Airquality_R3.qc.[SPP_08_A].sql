...
/****** Object:  View [qc].[SPP.08.A]    Script Date: 25/05/2026 09:44:26 ******/
SET ANSI_NULLS ON
GO
...
ON sp."method" = v."notation" COLLATE Latin1_General_CI_AS AND v."vocabulary" = 'measurementmethod'
WHERE 
