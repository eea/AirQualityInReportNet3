...
/****** Object:  View [qc].[SM_PK]    Script Date: 22/09/2025 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [qc].[SM_PK] AS

-- Creation date: 22 September 2025
-- QC rule code: SM_PK
-- QC rule name: SM_PK Constraint - [CountryCode,ScenarioId,ScenarioCategory,MeasureGroupId]
