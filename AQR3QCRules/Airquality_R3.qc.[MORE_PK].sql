...
/****** Object:  View [qc].[MORE_PK]    Script Date: 22/09/2025 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [qc].[MORE_PK] AS

-- Creation date: 22 September 2025
-- QC rule code: MORE_PK
-- QC rule name: MORE_PK Constraint - [CountryCode,AssessmentMethodId,Start,DataAggregationProcessId]
