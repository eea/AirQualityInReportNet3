...
/****** Object:  View [qc].[MORE_02_A]    Script Date: 26/08/2025 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [qc].[MORE_02_A] AS

-- Creation date: 26 August 2025
-- QC rule code: MORE_02_A
-- QC rule name: MORE_02_A Cross-check - [AssessmentMethodId] MOD_02
